...
class Habit(models.Model):
    ...
    frequency_days = models.PositiveIntegerField(default=1, help_text="Периодичность в днях (1-7)")
    estimated_time_seconds = models.PositiveIntegerField(default=120, help_text="Время на выполнение (секунды, макс 120)")
    ...
    def __str__(self):
        return f"{self.action} by {self.user.tg_nik}"
